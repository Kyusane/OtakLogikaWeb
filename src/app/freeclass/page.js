               ...
               <section className="w-full h-[90vh] bg-main-dark flex flex-col justify-evenly items-center">
                    <div>
                         <h1 className="text-8xl text-center">
                              Our <span className="text-secondary-normal">Class AI helpful</span><br />  for everyone
                         </h1>
                    ...
                    <div>
                         <form>
                              <input type="text" className="focus:outline-main-normal text-main-darker p-5 w-[50vw] rounded-xl" placeholder="Search Class" />
                         </form>
                    </div>
               </section>
          </>
